    ...
    <>
      ...
      <div className="bg-white ">
        ...
        <header className="relative bg-white">
          <p className="flex h-10 items-center justify-center bg-rabbit-red px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
                  ...
                  <div className="ml-4 flow-root lg:ml-6">
                    <div className="group -m-2 flex items-center p-2">
                      <ShoppingBagIcon
                        ...
                        aria-hidden="true"
                        className="size-6 cursor-pointer shrink-0 text-gray-400 group-hover:text-gray-500"
                      />
      ...
      <CartDrawer open={isCartOpen} onClose={toggleCartDrawer} />
    </>
  )
}
